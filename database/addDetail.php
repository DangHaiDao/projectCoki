        ...
        <form action='cart.php' method='post'>
            <div id='quantity-and-buy-product' style='display: flex; align-items: center;'>
                <div id='quantity'>
                    ...
                    <input type='text' id='ip-text-quantity' value='1' onkeypress='return isNumberKey(event)' name='qntP'>
                    <button class='modify-quantity-btn' onclick='increaseQuantity()'>+</button>
                </div>
                <input type='submit' id='add-to-cart-btn' value='ADD TO CART' name='btnATC'>
            </div>

            <input type='hidden' name='img' value='../assets/img/$result[5]'>
            <input type='hidden' name='name' value='$result[2]'>
            <input type='hidden' name='realP' value='$result[4]'>
            <input type='hidden' name='saleP' value='$result[3]'>
        </form>
