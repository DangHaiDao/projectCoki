...
<?php
	if(isset($_POST['themsanpham'])){
		...
		$sql_insert_product = mysqli_query($connect,"INSERT INTO product values ('','$danhmuc','$tensanpham','$gia','$giakhuyenmai','$path','$mota')");
            ...
            <div class="col-md-4">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="tensanpham"
                        value="<?php echo $row_capnhat['title'] ?>"><br>
                    <input type="hidden" class="form-control" name="id_update"
                        value="<?php echo $row_capnhat['product_id'] ?>">
                    ...
                    <input type="text" class="form-control" name="giasanpham"
                        value="<?php echo $row_capnhat['price'] ?>"><br>
                    <label>Giá khuyến mãi</label>
                    <input type="text" class="form-control" name="giakhuyenmai"
                        value="<?php echo $row_capnhat['discount'] ?>"><br>
                    <label>Mô tả</label>
                    <textarea class="form-control" rows="10"
                        name="mota"><?php echo $row_capnhat['description'] ?></textarea><br>
                    ...
                    <input style="background-color:blue" type="submit" name="capnhatsanpham" value="Cập nhật sản phẩm"
